// Game Engine Project.cpp : Defines the entry point for the application.
//
#include "framework.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_GAMEENGINEPROJECT, szWindowClass, MAX_LOADSTRING);
    ...
    while(PeekMessage(&msg, msg.hwnd, 0, 0, 0))
    {
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_GAMEENGINEPROJECT));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_GAMEENGINEPROJECT);
